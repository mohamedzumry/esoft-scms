...
// Define BreadcrumbItem type (if '@/types' doesn’t exist)
...
export default function Dashboard() {
    // Use proper type assertion with usePage
    const { courses, students, lecturers, recentCourses } = usePage<DashboardProps>().props;

    // Explicitly type chartData with ChartData<'bar'>
